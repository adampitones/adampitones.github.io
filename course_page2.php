...
<html>
	...
	<div class="col-md-3">
		  <ul class="nav nav-pills nav-stacked">
			...
			<li><a href="#csce444" data-toggle="pill">CSCE 444</a></li>
			<li class="active"><a href="#anth210" data-toggle="pill">ANTH 210</a></li>
		...
		<!--Course Information -->
		<div class="tab-pane fade" id="csce444">
		...
		<div class="tab-content">
			<div class="tab-pane fade in active" id="A">
				...
				<hr>
				<button class="btn btn-success" ng-disabled="error || incomplete" ng-click="save(1)">
			...
			<div class="tab-pane fade" id="B">Content inside tab B</div> <!--Notes should go inside this div -->
	  ...
	  <!--Course Information -->
	  <div class="tab-pane fade in active" id="anth210"> <!--Course information for ANTH 210 start here -->
		...
		<div class="tab-content">
			<div class="tab-pane fade in active" id="A">
				...
				<hr>
				<button class="btn btn-success" ng-disabled="error || incomplete" ng-click="save(2)">
				<span class="glyphicon glyphicon-save"></span>  Save Changes
				</button>
	  ...
	  <div class="tab-pane fade" id="eng110"> <!--Course information for ENG 110 start here -->
		...
		<div class="tab-content">
			<div class="tab-pane fade in active" id="A">
				...
				<hr>
				<button class="btn btn-success" ng-disabled="error || incomplete" ng-click="save(3)">
				<span class="glyphicon glyphicon-save"></span>  Save Changes
				</button>
